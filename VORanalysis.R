# title: "VORanalysis.R"
# assignment: "VOR Data for daily, sibships, shake n roll, poke-an-egg experiment (conducted summer 2015)"
# author: "Julie Jung"
# date last updated: "October 10, 2017"
###

rm(list=ls()) #clear environment
setwd('/Users/juliejung/Documents/GitHub/VOR-ms') #set working directory       
...
c105 <- subset(SubsetSibshipsSonia.df, Clutch == "105")
...
max(ShakeRoll.df$SUM.of.trait.values)
